...
<head>
    ...
    <title>T4R - Religious Places</title>
</head>

<body style="background: linear-gradient(to right, aqua, #4E4376);">
    <div class="heading1">
        <h1>Famous Religious Places</h1>
    ...
    <!-- <section class="container1">
        <div class="card1">
            ...
            <div class="card-image1 car-1">
            </div>
            <h2> Ahmedabad</h2>
           
                 <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reiciendis quo facere fugit qui. Vel aspernatur rerum esse voluptatum nobis facilis, aperiam molestias repellendus? Officiis, sint.</p> 
                <h6>$1000.00</h6>
                <ul>
        ...
        <div class="card1">
            ...
            <h2>Surat</h2>
                 <p>
Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia minima culpa, reprehenderit ullam iste inventore dolorem debitis unde perferendis esse ad placeat sit molestiae eligendi?
                </p> 
                <h6>$500.00</h6>
                <ul>
                    <li><i class="fa fa-star checked"></i></li>
        ...
        <div class="card1">
            ...
            <h2>Vadodara</h2>
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Rerum cum officiis numquam quia, nulla saepe rem minima fugiat voluptate provident tempore ut modi ipsam aliquam!</p> 
                <h6>$900.00</h6>
                <ul>
                    <li><i class="fa fa-star checked"></i></li>
                    <li><i class="fa fa-star checked"></i></li>
            ...
            <div class="left-col">
                ...
                <div class="package">
                    <div class="package-img">
                        <img src="img/pack/11-akshardham.jpg">
                    </div>
                    <div class="package-info">
                        <p>Ahmedabad's one of the best heritage destination</p>
                        <h3>Akshardham</h3>
                        <p>5 days-4 nights / Ahmedabad to Baroda / 01-Mar-23 -> 05-Mar-23</p>
                ...
                <div class="package">
                    <div class="package-img">
                        <img src="img/pack/somnath-temple.jpg">
                    </div>
                    <div class="package-info">
                        <p>Ahmedabad's one of the best heritage destination</p>
                        <h3>Somnath</h3>
                ...
                <div class="package">
                    <div class="package-img">
                        <img src="img/pack/palitana.jpeg">
                    </div>
                    <div class="package-info">
                        <p>Ahmedabad's one of the best heritage destination</p>
                        <h3>Palitana</h3>
                ...
                <div class="package">
                    <div class="package-img">
                        <img src="img/pack/sarangpur.jpg">
                    </div>
                    <div class="package-info">
                        <p>Ahmedabad's one of the best heritage destination</p>
                        <h3>Kasta Bhanjandev Temple</h3>
                        <p>5 days-4 nights / Ahmedabad to Baroda / 01-Mar-23 -> 05-Mar-23</p>
                        <i class="fa fa-star checked"></i>
                        <i class="fa fa-star checked"></i>
                        <i class="fa fa-star checked"></i>
    ...
    $sql = "SELECT * FROM package where package_category='Religious'";
