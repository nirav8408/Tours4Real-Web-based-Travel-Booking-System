...
<body style="background: linear-gradient(to right, aqua, #4E4376);">
    <div class="heading1">
        <h1>Popoular Cities</h1>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Praesentium est fuga animi quasi ut aliquid illo
            consequuntur, velit odit necessitatibus!</p>
    </div>
    <section class="about-us">
        <img src="img/pack/package by city.jpeg" alt="">
        <div class="content1">
            <h2>Lorem, ipsum dolor.
            </h2>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Omnis pariatur voluptate inventore sint vero
                iste velit unde facere dolore provident.</p>
        </div>
    </section>
    <br><br><br><br><br><br>
    ...
    $sql = "SELECT * FROM package where package_category='City'";
                ...
                <div class='left-col'>
                    <div class="package">
                        ...
                        <div class="package-info">
                            ...
                            ?>
                                <br>Arrival date <?php echo $row1["Arrival_dt"]; ?> to Leaving date
                                <?php echo $row1["Leaving_dt"]; ?>
                            <?php } ?><br>
