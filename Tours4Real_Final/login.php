    ...
    include("config.php");
     if(isset($_POST['sub']))
     {
         ...
         if(mysqli_num_rows($result)==1)
         {
            if($uname=='admin')
            {
                echo '<script>alert("You cannot login as Admin")</script>';
            }
            else
            {
            ...
            echo '<script>alert("Username or Password is invalid / Account is Deleted")</script>';
         }
     }
    ?>
    <section>
        ...
        <div class="contentBx">
            <div class="formBx">
                <h2 style="color: #342D7E;">Sign-in</h2>
