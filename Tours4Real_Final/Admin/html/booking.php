...
<?php
    ...
    $sql="SELECT b.book_id, r.username, r.email, p.package_name, p.pack_category_name, b.card_holder, b.adults, b.childrens, b.total_price, b.Arrival_DT, b.Leaving_DT, b.book_date,b.cancel from registration r, package p, booking b where 
    p.package_id=b.package_id AND r.user_id=b.user_id ORDER BY b.book_id DESC";
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-6">
                        ...
                        <h1 class="mb-0 fw-bold">Bookings</h1>
                    </div>
                    <div class="col-6">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h1 class="card-title">Booking Data</h1>
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                while($row=mysqli_fetch_assoc($result))
                                                {
                                                    ...
                                                    echo "<td>";
                                                    if($row['cancel']==1){
                                                    echo "<h5 style='color: red;'>Cancelled</h5>";}else{echo "<h5 style='color: green;'>Booked</h5>";}
                                                    echo "</td>";
